import S from './texto_principal.module.css'

export function TextoPrincipal() {
  return (
    <div className={S.box_texto_principal}>
      <h1 className={S.titulo_texto_principal}>Ajude o algorítimo a ser mais certeiro</h1>
      <p className={S.texto_principal}>
